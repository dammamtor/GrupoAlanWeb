...
public class ProductsRoly {
    ...
    private String packincr;
    private String unitsincr;
    private String boxsize;
    private String weight;
    private String taric;
    private String madein;
    private String canondigital;
    ...
    public void setBoxunits(String boxunits) {
    ...
    public boolean isIsforchildren() {
    ...
    public String getPackincr() {
        return packincr;
    }

    public void setPackincr(String packincr) {
        this.packincr = packincr;
    }

    public String getUnitsincr() {
        return unitsincr;
    }

    public void setUnitsincr(String unitsincr) {
        this.unitsincr = unitsincr;
    }
    ...
    public String getCanondigital() {
        return canondigital;
    }

    public void setCanondigital(String canondigital) {
